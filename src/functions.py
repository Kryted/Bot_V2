...
# print(reading_employee())    #тест функция выводит всех сотрудников

##### не тестить функцию ниже!!!
# write_employee({'tdryn4ik': ['Андрей Тарасов', 123456]})    #тест функция добавляет нового сотрудника
#
# add_new_employee("L_Art007", 'Артем Лазарев', 654321)    #тест добавляет нового сотрудника в словарь сотрудников
#
# delete_old_employee("L_Art007", 'Артем Лазарев', 654321)    #тест удаляет сотрудника
#
# search_employee_data('tdryn4ik')  #ищет данные сотрудника по id телеграмма